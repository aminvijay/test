...
public class BuySellStockDate1 {
	...
	public static void main(String[] args) {
		...
		preictedMap.put(2, 32);
		preictedMap.put(3, 27);
		preictedMap.put(4, 25);
		preictedMap.put(5, 26);
		preictedMap.put(6, 29);
		preictedMap.put(7, 30);
		preictedMap.put(8, 33);
		preictedMap.put(9, 24);
