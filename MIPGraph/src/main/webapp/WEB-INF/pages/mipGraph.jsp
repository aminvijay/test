    ...
    <script type="text/javascript">
		...
		$(document).ready(function() {			
			...
			$('#submitGraph').click(function (){				
				...
				var priorityURL =  "http://l-sjn-00559908.corp.ebay.com:8080/MIPGraph/MIPGraph/mipGraphDataNo?startDateTime="+startDateTime+"&endDateTime="+endDateTime+"&feedTypes="+feedTypes+"&sellers="+sellers;
